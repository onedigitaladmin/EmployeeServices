...
public class EmployeeServicesApp {

    private static final Logger log = LoggerFactory.getLogger(EmployeeServicesApp.class);

    private final Environment env;

    public EmployeeServicesApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes EmployeeServices.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EmployeeServicesApp.class);
